          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-4 sm:gap-5 mb-20 sm:mb-28">
            {services.map((s, i) => (
              <motion.div key={s.num}
                ...
                viewport={{ once: true, amount: 0.05 }} transition={{ duration: 0.65, delay: i * 0.08 }}
                whileHover={{ y: -6 }}
            ...
            <motion.div
              initial={{ opacity: 0, y: 36 }} whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true, amount: 0.05 }} transition={{ duration: 0.65, delay: 0.45 }}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-px bg-white/[0.05]">
              {process.map((p, i) => (
                <motion.div key={p.step}
                  ...
                  viewport={{ once: true, amount: 0.05 }} transition={{ duration: 0.55, delay: i * 0.09 }}
