          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 mb-20 sm:mb-28">
            ...
            <ScrollReveal delay={0.1}>
              <div className="relative inline-block">
                ...
                <div className="relative w-full max-w-[320px] sm:max-w-[360px]" style={{ aspectRatio: "3/4" }}>
                ...
                {/* badge */}
                <div className="mt-3 sm:absolute sm:mt-0 sm:bottom-[-12px] sm:right-0 bg-[#0a0c12] border border-blue-500/20 px-4 py-2.5">
            ...
            <ScrollReveal delay={0.15} className="flex flex-col justify-center">
              ...
              <div className="flex flex-wrap gap-3">
                <a href="/cv.pdf" download data-hover
